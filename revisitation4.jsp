  <%
                                                      String title="tRank Caluculation";
													  %>
...
%>
						...
						<div class="alert alert-warning" role="alert">
							<strong>tRank= {(Ratio of the time length(Len(w,d))+TFIDF)/2}</strong> 
						</div>
...
%>
<table width="100%" border id="tab">						
<tr><th>URL ID<th>URL<th>Ratio of the time length<th>TF-IDF Score<th>tRank
<%
int count=0;
String temp="";
while(rs.next())
